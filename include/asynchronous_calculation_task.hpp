// asynchronous_calculation_task.hpp
#pragma once
#include <string>
#include <memory>
...
class asynchronous_calculation_task: public calculation_task
{
public:
   typedef asynchronous_calculation_task self_type;
   typedef self_type *ptr;
   typedef std::shared_ptr<self_type> shared_ptr;
   typedef std::vector<counter::shared_ptr> counter_vector_type;

   template <typename F>
   asynchronous_calculation_task(
      vertex_descriptor v,
      F &&stuff,
